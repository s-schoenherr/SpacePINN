...
import spacepinn
from spacepinn.config.config_3d import geometric_3d_config, ordinary_3d_config
...
def build_configs(*, smoke: bool | None = None) -> list[dict]:
    geometric_runtime_config = deepcopy(geometric_3d_config)
    ordinary_runtime_config = deepcopy(ordinary_3d_config)
